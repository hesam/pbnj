...
<YYINITIAL> {
  ...
  "assume"                       { return key(sym.ASSUME); }
  "enum"                         { return key(sym.ENUM); }
  "==>"                          { return key(sym.IMPLIES); }
  "<==>"                         { return key(sym.IFF); }
  "spec"                         { return key(sym.SPEC); }
  "requires"                     { return key(sym.REQUIRES); }
  ...
  "fresh"                        { return key(sym.FRESH); }
  "uniqueresults"                { return key(sym.UNIQUERESULTS); }
  "primitive"                    { return key(sym.PRIMITIVE); }
  "all"                          { return key(sym.ALL); }
  "some"                         { return key(sym.SOME); }
  "no"                           { return key(sym.NO); }
  "one"                          { return key(sym.ONE); }
  "lone"                         { return key(sym.LONE); }
  ".."                           { return key(sym.DOTDOT); }
//  "|XOR|"                          { return key(sym.ESJXOR); }
