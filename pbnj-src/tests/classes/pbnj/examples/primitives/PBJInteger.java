...
public final class PBJInteger implements java.io.Serializable, polyglot.ext.pbnj.primitives.PBJInternObject {
    private int value;
    
    private static HashMap<Integer, PBJInteger> instances =
      new HashMap<Integer, PBJInteger>();
    ...
    public PBJInteger(polyglot.ext.pbnj.tologic.LogExpr dontcare) {
        super();
        this.addInstance();
    }
    ...
    public void addInstance() {
        polyglot.ext.pbnj.tologic.LogMap.addInstance(PBJInteger.class,
                                                     this);
    }
    
    public void addInstanceForProblem(PBJInteger toAdd,
        ...
        fallback_problem.addToClassInstances(toAdd,
                                             PBJInteger.class,
                                             "pbnj.examples.primitives.PBJInteger",
    ...
    public PBJInteger fallback_setTypeArgs(String[] args) {
    ...
    public static boolean isClassRelationized(polyglot.ext.pbnj.tologic.LogProblem fallback_problem) {
        return PBJInteger.classRelationizerStep ==
          fallback_problem.relationizerStep();
    }
    ...
    public static boolean isClassAtomized(polyglot.ext.pbnj.tologic.LogProblem fallback_problem) {
        return PBJInteger.classAtomizerStep ==
          fallback_problem.relationizerStep();
    }
    ...
    public static boolean isClassCloned() {
        return PBJInteger.classClonerStep ==
          polyglot.ext.pbnj.tologic.LogMap.clonerStep();
    }
    ...
    public void fallback_atomize(polyglot.ext.pbnj.tologic.LogProblem fallback_problem,
        ...
        if (!isAtomized(fallback_problem)) {
            this.atomizerStep =
              fallback_problem.relationizerStep();
            PBJInteger.fallback_classAtomize(fallback_problem,
                                             fallback_targetTypeArgsStr,
    ...
    public void fallback_relationizeOld(polyglot.ext.pbnj.tologic.LogProblem fallback_problem,
        ...
        if (!isRelationized(fallback_problem)) {
            this.relationizerStep =
              fallback_problem.relationizerStep();
            PBJInteger.fallback_classRelationizeOld(fallback_problem,
                                                    fallback_targetTypeArgsStr,
                                                    fallback_targetTypeArgs);
            PBJInteger.value_old_get_log(fallback_problem,
                                         fallback_targetTypeArgsStr,
    ...
    public static void fallback_classRelationizeOld(polyglot.ext.pbnj.tologic.LogProblem fallback_problem,
        ...
        if (!isClassRelationized(fallback_problem)) {
            PBJInteger.classRelationizerStep =
              fallback_problem.relationizerStep();
        }
    }
    ...
    public PBJInteger fallback_clone() {
        if (isCloned())
            return old;
        PBJInteger res =
          null;
        PBJInteger.fallback_classClone();
        try {
            res =
              this;
            res.isOld =
    ...
    public static polyglot.ext.pbnj.primitives.PBJInternSet<Integer> setMap_value(polyglot.ext.pbnj.primitives.PBJInternSet<PBJInteger> objs,
                                                                                  java.lang.String ... fieldNs) {
        polyglot.ext.pbnj.primitives.PBJInternSet<Integer> res =
          new polyglot.ext.pbnj.primitives.PBJInternSet<Integer>();
        java.util.Iterator<PBJInteger> i =
          objs.iterator();
        while (i.hasNext()) {
    ...
    static {
               polyglot.ext.pbnj.tologic.LogMap.newClassForLog(PBJInteger.class,
                                                               true);
    ...
    public static polyglot.ext.pbnj.tologic.LogExpr value_log(polyglot.ext.pbnj.tologic.LogProblem fallback_problem,
                                                              polyglot.ext.pbnj.tologic.LogExpr fallback_target,
                                                              String fallback_targetTypeArgsStr,
                                                              String[] fallback_targetTypeArgs,
                                                              boolean fallback_target_isOld) {
        return PBJInteger.value_get_log(fallback_problem,
                                        fallback_target,
                                        fallback_targetTypeArgsStr,
                                        fallback_targetTypeArgs,
