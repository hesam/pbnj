...
public class Test implements PBJInternObject {
    ...
    LogProblem testTriggerScaleMain_planb() {
        ...
        fallback_problem.setModifiableField("at.ac.testing.RequestCounts.counts");
    ...
    static {
               ...
               LogMap.newInstVarRel("currentConfiguration",
                                    ...
                                    "at.ac.testing.Test",
                                    CurrentConfiguration.class,
                                    "at.ac.testing.CurrentConfiguration",
                                    null,
                                    null,
                                    false,
                                    false,
...
class CurrentContext implements PBJInternObject {
    ...
    public CurrentContext() {
        super();
        this.requestCounts =
          new ArrayList<RequestCounts>().fallback_setTypeArgs(new String[] { "at.ac.testing.RequestCounts" });
        this.addInstance();
    }
        ...
        if (!isAtomized(fallback_problem)) {
            ...
            if (this.requestCounts !=
                ...
                this.requestCounts.fallback_atomize(fallback_problem,
                                                    "<at.ac.testing.RequestCounts>",
                                                    new String[] { "at.ac.testing.RequestCounts" });
        }
    }
    ...
    static {
               ...
               LogMap.newInstVarRel("requestCounts",
                                    ...
                                    "at.ac.testing.CurrentContext",
                                    ArrayList.class,
                                    "pbnj.util.ArrayList<at.ac.testing.RequestCounts>",
