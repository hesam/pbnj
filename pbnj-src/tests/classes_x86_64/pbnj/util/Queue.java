 ...
 * Besides basic {@link pbnj.util.Collection Collection} operations, queues provide
 ...
 * pbnj.util.Collection#add Collection.add} method, which can fail to
 ...
 * defined in the {@link pbnj.util.concurrent.BlockingQueue} interface, which
 ...
 *
 * @see pbnj.util.Collection
 * @see LinkedList
 * @see PriorityQueue
 * @see pbnj.util.concurrent.LinkedBlockingQueue
 * @see pbnj.util.concurrent.BlockingQueue
 * @see pbnj.util.concurrent.ArrayBlockingQueue
 * @see pbnj.util.concurrent.LinkedBlockingQueue
 * @see pbnj.util.concurrent.PriorityBlockingQueue
 * @since 1.5
 * @author Doug Lea
